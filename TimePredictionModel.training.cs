...
namespace Apetrei_Alexandru_Lab4
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\apetr\Desktop\E-BUSINESS\Medii\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=1423,MinimumExampleCountPerLeaf=20,LearningRate=0.4477729022031211,LabelColumnName=@"trip_time_in_secs",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.45982492598029684,FeatureFraction=0.99999999,L1Regularization=2.87098363009363E-10,L2Regularization=0.6905999387681454},MaximumBinCountPerFeature=239}));
